...
import 'package:linkedin_clone_ui/pages/auth/sign_up.dart';
import 'package:linkedin_clone_ui/pages/main/main_screen.dart';
import 'package:linkedin_clone_ui/theme/style.dart';
import 'package:linkedin_clone_ui/widgets/button_container_widget.dart';
import 'package:linkedin_clone_ui/widgets/googleBtn_container_widget.dart';
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text("Forgot password?", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: linkedInBlue0077B5),),
                    const SizedBox(height: 15,),
                    ...
                    Center(
                      child: RichText(
                        text: TextSpan(
                          ...
                          style: const TextStyle(color: linkedInBlack000000, fontSize: 16),
                          children: [
                            TextSpan(
                              ...
                              text: "Join now",
                               style: const TextStyle(color: linkedInBlue0077B5, fontWeight: FontWeight.bold, fontSize: 16)
                            )
                          ]
                        ),
                      ),
